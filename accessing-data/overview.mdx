...
If your importer has Incognito mode enabled, the API and webhooks are unavailable. See [instructions](/accessing-data/incognito-mode) for accessing data with Incognito enabled.
